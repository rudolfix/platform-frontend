...
describe("EtoProgressStepper", () => {
  it("Should show check when isDone is true", () => {
    const component1 = shallow(<EtoProgressStepper currentStep={1} stepProps={[mockData[0]]} />);
    const component2 = shallow(<EtoProgressStepper currentStep={1} stepProps={[mockData[1]]} />);
  ...
  it("Should render name of step when isDone is false", () => {
    const component = shallow(<EtoProgressStepper currentStep={1} stepProps={[mockData[1]]} />);
  ...
  it("Should simulate a click when square is clicked", () => {
    ...
    expect(mockData[1].onClick).to.be.calledOnce;
  });
});
