...
describe("<LayoutAuthorizedMenuComponent />", () => {
  it("should render investor menu", () => {
    const MyNeuWidgetComponent = shallow(<LayoutAuthorizedMenuComponent userType="investor" actionRequiredSettings={false}/>);
  ...
  it("should render issuer menu", () => {
    const MyNeuWidgetComponent = shallow(<LayoutAuthorizedMenuComponent userType="issuer" actionRequiredSettings={false}/>);
