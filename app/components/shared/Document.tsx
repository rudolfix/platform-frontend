...
export const Document: React.SFC<IDocumentProps> = ({extension}) => {
  ...
  return (
    <svg viewBox="0 0 61 73" className={cn("document-icon", styles.document, computedExtension)}>
      ...
      <text className={styles.text} fontSize="8">
        <tspan x="12" y="47">.{computedExtension}</tspan>
      </text>
    </svg>
  )
}

export const DocumentTile: React.SFC<IDocumentProps & IDocumentTileProps> = ({extension, title}) => {
  return (
