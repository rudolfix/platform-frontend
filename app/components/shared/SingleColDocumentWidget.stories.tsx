...
const documents: IEtoDocument[] = [{
  ...
  form:
    "template",
  ipfsHash:
    "QmNM2rN6fi9TTjnB3pkFUb6MsAYxxbHjL4n5Fs5zxeb5Eq",
  mimeType:
  ...
  form:
    "template",
  ipfsHash:
    "QmRkGwa5UsobQ7ispn3UaKFU6Fv5iJkLf3Y4rmyrhqPUGy",
  mimeType:
    "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
  name:
  ...
  form:
    "template",
  ipfsHash:
    "QmUbU1jFuJdpArXuPPPQBde2vg3p6LPy6CPK3e3Rw5ACoC",
  mimeType:
    "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
  name:
  ...
  form:
    "template",
  ipfsHash:
    "QmQYWyx6WWwCYqBnJ74ruogTTHfKoscQRHU5eJFKDD22mT",
  mimeType:
    "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
  name:
  ...
  form:
    "template",
  ipfsHash:
    "QmUrCYBhQCpfRyVqgWEVUCV9vTextCPaAq28ZyNNJ8CBXY",
  mimeType:
    "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
  name:
  ...
  form:
    "template",
  ipfsHash:
    "QmRLwyTw4ux84KnYvhejTsUggi2SeewGqASuh3DrURtyot",
  mimeType:
    "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
  name:
    "termsheet_template",
