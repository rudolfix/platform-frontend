...
import { EHumanReadableFormat, ToHumanReadableForm } from "./ToHumanReadableForm";

storiesOf("ToHumanReadableForm", module)
  .add("one million", () => <ToHumanReadableForm number={1000000} />)
  .add("one million short", () => (
    <ToHumanReadableForm number={1000000} format={EHumanReadableFormat.SHORT} />
  ))
  .add("2 millions", () => <ToHumanReadableForm number={2000000} />)
  .add("2 millions short", () => (
    <ToHumanReadableForm number={2000000} format={EHumanReadableFormat.SHORT} />
  ))
  .add("5.5 millions", () => <ToHumanReadableForm number={5500000} />)
  .add("5.5 millions short", () => (
    <ToHumanReadableForm number={5500000} format={EHumanReadableFormat.SHORT} />
  ))
  ...
  .add("one thousand short", () => (
    <ToHumanReadableForm number={1000} format={EHumanReadableFormat.SHORT} />
  ))
  ...
  .add("125 thousands short", () => (
    <ToHumanReadableForm number={125000} format={EHumanReadableFormat.SHORT} />
  ))
    ...
    <ToHumanReadableForm number={1500000}>
      {divider => (
        <ToHumanReadableForm
          number={10000000}
          divider={divider}
          format={EHumanReadableFormat.SHORT}
        />
      )}
    </ToHumanReadableForm>
  ))
  ...
  .add("500 - 20000 short", () => (
    <ToHumanReadableForm number={500}>
      {divider => (
        <ToHumanReadableForm number={20000} divider={divider} format={EHumanReadableFormat.SHORT} />
      )}
    </ToHumanReadableForm>
  ));
