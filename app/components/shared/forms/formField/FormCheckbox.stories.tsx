    ...
    formWrapper({ bwm: false, audi: false, ford: true, volvo: true })(() => (
      <>
        <div className="form-group">
          <FormCheckbox name="bmw" label=" No shareholder loans exist and at Closing Date the Company does not have any outstanding liabilities vis-à-vis Existing Shareholders or related parties. asdf asdf asdf asdf asdf asdf asdf l(kj(lkj asdf asdf as df asdf)) bmw" />
        </div>
        <div className="form-group">
          <FormCheckbox name="bmw" label="bmw" />
          <FormCheckbox name="audi" label="audi" />
