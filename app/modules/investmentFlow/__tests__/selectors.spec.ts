...
function createStateWithAddress(address: string) {
...
describe("investment-flow > selectors", () => {
  ...
  describe("selectBankTransferReferenceCode", () => {
    it("generates a code from the address and gasprice", () => {
      const code1 = selectBankTransferReferenceCode(createStateWithAddress("0x0061c60a6477bb64aEc5dc8d3C892cC53C8084a3"))
      const code2 = selectBankTransferReferenceCode(createStateWithAddress("0x6e9A689BF3E87F7fc945D345A869841787447a35"))
      const code3 = selectBankTransferReferenceCode(createStateWithAddress("0x822060c96E012Bf88D08635A543210D1029b658D"))
