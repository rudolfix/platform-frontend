...
import {
  ...
  TEtoFormType,
} from "../modules/eto/lib/http/eto-api/EtoFileApi.interfaces";
import {
  EAssetType,
  EOfferingDocumentSubtype,
  EOfferingDocumentType,
  EProductName,
} from "../modules/eto/lib/http/eto-api/EtoProductsApi.interfaces";
import {
