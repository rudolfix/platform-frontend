...
export const RegisterBrowserWallet = compose<IStateProps & IDispatchProps & TAdditionalProps, {}>(
  ...
  branch<TBrowserWalletRegisterData>(({ walletState }) => walletState === EBrowserWalletState.BROWSER_WALLET_ASK_FOR_EMAIL,
    renderComponent(BrowserWalletAskForEmailAndTos)),
  branch<TBrowserWalletRegisterData>(({ walletState }) => walletState === EBrowserWalletState.BROWSER_WALLET_VERIFYING_EMAIL,
    renderComponent(WalletLoading)),
  branch<TBrowserWalletRegisterData>(({ walletState }) => walletState === EBrowserWalletState.BROWSER_WALLET_EMAIL_VERIFICATION_ERROR,
    renderComponent(BrowserWalletAskForEmailAndTos)),
