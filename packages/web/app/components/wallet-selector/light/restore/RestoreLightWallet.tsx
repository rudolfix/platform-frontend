...
import { RegisterEnhancedLightWalletForm } from "../register/RegisterLightWalletForm";
...
export const RestoreLightWallet = compose<TStateProps & TDispatchProps, TExternalProps>(
  ...
  withContainer<TWalletSelectorState>(compose<TWalletSelectorState, TWalletSelectorState>(
    branch<TWalletSelectorState>(({ flowType }) => flowType === EFlowType.RESTORE_WALLET, renderComponent(RecoverLightWalletBase)),
    branch<TWalletSelectorState>(({ flowType }) => flowType === EFlowType.IMPORT_WALLET, renderComponent(ImportLightWalletBase)),
