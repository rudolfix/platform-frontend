...
import { addPendingTransactions, clearPendingTransactions, goToWallet, tid } from "../utils/index";
...
describe("Pending Transactions In Header", () => {
  ...
  describe("Pending transactions component in transactions history", () => {
    it("should show pending transaction component when there is pending transaction", () => {
