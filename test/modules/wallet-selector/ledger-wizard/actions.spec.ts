...
describe("Wallet selector > Ledger wizard", () => {
  describe("loadLedgerAccounts action", () => {
    it("should load accounts from ledger connector", async () => {
      ...
      const ledgerConnectorMock = createMock(LedgerConnector, {
